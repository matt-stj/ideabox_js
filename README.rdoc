layout	title	sidebar	points
page
Revenge of IdeaBox
true
150
Nota bene: This project is the spiritual successor to Idea Box, but there is no requirement that you need to have done or even be aware of Idea Box to be successful on this project.
...
10 points - Application has exceptionally well-factored code with little or no duplication and all components separated out into logical components. There zero instances where an instructor would recommend taking a different approach.
